...
In this experiment, I used the Seaborn library in Python to visualize the Titanic dataset and explore its features. After importing the necessary libraries, I created different plots such as line, bar, scatter, and bubble charts to study trends and relationships between variables like Age, Fare, and Passenger Class. The histogram showed survival rates across classes, while the box and violin plots highlighted how age and fare varied among them. The KDE plot displayed the age distribution, and the heatmap helped identify correlations between numerical values. Overall, this experiment helped me understand how Seaborn can turn raw data into clear and meaningful visuals, making it easier to find insights like how class, age, and fare influenced survival on the Titanic.
